...
def find_longest_word(word_list)
  ...
  word_list.reduce do |longest, word|
...
def find_longer_words(word_list, base_word)
  ...
  word_list.reduce([]) do |array, word|
    array.push(word) if word.length > base_word.length
    array
  end
end
...
def find_word_lengths(word_list)
  ...
  word_list.reduce(Hash.new(0)) do |array,word|
